...
excerpt: "AngelFolio Supabase?! Ramp Ghosted Me?! BreadGetter?! What do you mean there's no likes and comments yet ☹️ and more."
emoji: "😎📃"
imageURI: "https://images.unsplash.com/photo-1668450433152-e56d7e8fe4ee?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80"
tags: ["MDX","Rant","Supabase","Tech"]
project: "angelfolio"
date: "2023-01-07"
---
...
<br/>
<div>I ended up making a table for <Utils>Tags</Utils>, and another table for <Utils>PostTags</Utils>. The tags table is like the actual "TagName" and description of the tag, while the PostTags table relates the **post** foreign key and the **tag** foreign key to create that "One-to-Many" relationship between posts and tags. Manually adding tags and linking them to posts is a bit cumbersome because of this, but once I build out a dashboard I'll abstract it all away 😎.</div>
<br/>
### The Dashboard
...
<br/>
<img src="https://i.imgur.com/zQy4vdv.png" width="100%" height="auto"/>
<br/>
<br/>
...
<div style={{display: 'flex', justifyContent: 'center'}}>
  <img src="https://i.imgur.com/Vf4oxZj.png" width="300" height="300"/>
</div>
<br/>
Real talk, [Ramp](https://ramp.com/) is not ghosting me. I've been meaning to publish a post about the really cool CodeSandbox Challenge they've cooked up for the [Software Engineering Internship](https://www.linkedin.com/jobs/view/3403095894) Application this year, but I wasn't sure who to contact to ask whether or not I could publish it. So, I cold-messaged a talent-acquisition person at Ramp on LinkedIn (truly not my greatest idea). I've been waiting for a response back for a while now, so I'll probably post the content sometime soon 😊.

P.S. I forgot to comment my code. Hopefully they don't toss out my application because of that 😭.

## Angel on 100Devs WHAT
<br/>
I love the idea and mission of [100Devs](https://leonnoel.com/100devs/). Not only that, I've connected with a few of the members and actively follow their githubs. Its not until recently that I applied to the program! Regardless of whether or not I earn a spot, I'll still keep up with the lessons regardless since they're all public and on Discord/Github! 
...
That's Pretty much everything! I'll make another blog post for the ramp thing, and I might touch on some Polytechnic University of Puerto Rico programming stuff soon too 😳. See ya! 👋.

## What I'm BUMPIN Today
<br/>
<iframe style={{borderRadius:'12px'}}  src="https://open.spotify.com/embed/track/2pscAWkm3jAxcrpBwOtQmS?utm_source=generator" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
