...
export const SuccessSnackbar = ({
   ...
   }, [open, onClose, closeTimeout]);
   return (
      <div
         className={`flex items-center w-full max-w-xs p-4 border-green-500 border-2 gap-x-2 rounded-lg shadow-sm bg-black transition-all duration-100  ${
            open ? 'opacity-1 translate-y-0' : 'opacity-0 translate-y-4'
         }`}
         role='alert'
      >
         <div className='inline-flex items-center justify-center shrink-0 w-8 h-8 rounded-lg text-white border-gray-500 border-[1px] bg-gray-800 hover:bg-gray-900'>
