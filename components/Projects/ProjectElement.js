    ...
    return (
        ...
        <div className="project-top-group">
            <div className="project-name-group">
                <div className="project-element-name">
                    {project.name}
                </div>
                {project?.github?.isPublic ? (
                <Link href={project.github.url} className="project-github-public">
                    <p>Public</p>
                    <FontAwesomeIcon className="project-element-github" icon={faGithub}/>
                </Link>
                ): (
            ...
            <div className="project-date-group">
                {project.date}
            </div>
        </div>
        ...
        <div className="project-bottom-group">
            ...
            <Link href={`/projects/${project.slug}`}className="project-see-more" >
                <p>Read More . . .</p>
            </Link>
        </div>
    </animated.div>
